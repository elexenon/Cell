...
void SettingsPageWidget::Init()
{
    ...
    TOOLS::multiModulesOneStyleSheet({ui->label_colorScheme,ui->labelLicense,ui->label_about},
    ...
    TOOLS::multiModulesOneStyleSheet({ui->label_auto,ui->label_auto_hint},
                                       QStringLiteral("color:#798186; background-color:#dadada"));
...
{   
    ...
    TOOLS::setPropertyAnimation({scrollAreaContents_animi},"color",LITERAL::MAINWINDOW_BRIGHT,LITERAL::MAINWINDOW_DARK,500,
    ...
    TOOLS::setPropertyAnimation({frame_optionBlock1_animi,frame_optionBlock2_animi,
                                  ...
                                  "color", frame_optionBlock1->color(),LITERAL::COLOR_OPTION_BLOCK_DARK,500,QEasingCurve::InOutCubic,
    ...
    // Text Label.
    TOOLS::multiModulesOneStyleSheet({ui->label_colorScheme,ui->labelLicense,ui->labelLicenseHint,ui->label_about},
...
void SettingsPageWidget::modulesChangeToBrightness()    // Color_Scheme_Switch.
{
    ...
    TOOLS::setPropertyAnimation({scrollAreaContents_animi},"color",LITERAL::MAINWINDOW_DARK,LITERAL::MAINWINDOW_BRIGHT,500,
                                  QEasingCurve::InOutCubic,{scrollAreaWidgetContents},nullptr);

    TOOLS::setPropertyAnimation({frame_optionBlock1_animi,frame_optionBlock2_animi,
                                   frame_optionBlock3_animi,frame_optionBlock4_animi},
                                  "color", frame_optionBlock1->color(),LITERAL::COLOR_OPTION_BLOCK_BRIGHT,500,QEasingCurve::InOutCubic,
                                  {frame_optionBlock1,frame_optionBlock2,
                                   frame_optionBlock3,frame_optionBlock4},nullptr);
    // Ratio Btns.
    TOOLS::multiModulesOneStyleSheet({ui->radioBtn_bright,ui->radioBtn_dark},
