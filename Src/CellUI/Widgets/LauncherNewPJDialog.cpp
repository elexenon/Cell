...
LauncherNewPJDialog::LauncherNewPJDialog(CellGlobal::COLOR_SCHEME globalMode,QWidget *parent) :
    ...
    Btn_Confirm_label(new customLabel(Cell_Const::QSS_CUSTOMLABEL_TRANSPARENT,Btn_Confirm)),
    Btn_Cancel_label(new customLabel(Cell_Const::QSS_CUSTOMLABEL_TRANSPARENT,Btn_Cancel)),
...
void LauncherNewPJDialog::Init()
{
    ...
    label_choose->setGeometry(24, 55, 150, 50);
    ...
    LauncherNewPJ_line_splitter1->setGeometry(QRect(0, 148, 200, 1));
    ...
    label_project->setFont(QFont("微软雅黑 Light"));
    label_project->setColor(Cell_Const::GRAYLEVEL70);

    Tab_Cell->setObjectName(QStringLiteral("Tab_Cell"));
    Tab_Cell->setBrightModeCheckedUncheckedColor(Cell_Const::GRAYLEVEL247,Cell_Const::GRAYLEVEL255);
    Tab_Cell->setDarkModeCheckedUncheckedColor(Cell_Const::GRAYLEVEL70,Cell_Const::GRAYLEVEL30);
    Tab_Cell->Init();
    Tab_Cell->setGeometry(0, 149, 200, 40);
    ...
    Tab_Others_Label->setFont(QFont("微软雅黑 Light",11));
    ...
    label_file->setFont(QFont("微软雅黑 Light",9));
    label_file->setColor(Cell_Const::GRAYLEVEL70);

    LauncherNewPJ_line_splitter2->setObjectName(QString::fromUtf8("LauncherNewPJ_line_splitter2"));
    LauncherNewPJ_line_splitter2->setGeometry(QRect(0, 269, 200, 1));
    ...
    Tab_Empty->setBrightModeCheckedUncheckedColor(Cell_Const::GRAYLEVEL247,Cell_Const::GRAYLEVEL255);
    Tab_Empty->setDarkModeCheckedUncheckedColor(Cell_Const::GRAYLEVEL70,Cell_Const::GRAYLEVEL30);
    Tab_Empty->Init();
    Tab_Empty->setGeometry(0, 270, 200, 40);
    ...
    Tab_Empty_Label->setFont(QFont(QStringLiteral("微软雅黑 Light"),11));
    Tab_Empty_Label->setColor(Cell_Const::GRAYLEVEL70);

    Tab_CPP->setObjectName(QStringLiteral("Tab_CPP"));
    Tab_CPP->setBrightModeCheckedUncheckedColor(Cell_Const::GRAYLEVEL247,Cell_Const::GRAYLEVEL255);
    Tab_CPP->setDarkModeCheckedUncheckedColor(Cell_Const::GRAYLEVEL70,Cell_Const::GRAYLEVEL30);
    Tab_CPP->Init();
    Tab_CPP->setGeometry(0, 310, 200, 40);
    ...
    Tab_CPP_Label->setFont(QFont(QStringLiteral("微软雅黑 Light"),11));
    Tab_CPP_Label->setColor(Cell_Const::GRAYLEVEL70);

    Tab_Py->setObjectName(QStringLiteral("Tab_Py"));
    Tab_Py->setBrightModeCheckedUncheckedColor(Cell_Const::GRAYLEVEL247,Cell_Const::GRAYLEVEL255);
    Tab_Py->setDarkModeCheckedUncheckedColor(Cell_Const::GRAYLEVEL70,Cell_Const::GRAYLEVEL30);
    Tab_Py->Init();
    Tab_Py->setGeometry(0, 350, 200, 40);
    ...
    Tab_Py_Label->setFont(QFont(QStringLiteral("微软雅黑 Light"),11));
    Tab_Py_Label->setColor(Cell_Const::GRAYLEVEL70);

    Btn_Confirm->setObjectName(QStringLiteral("Btn_Confirm"));
    Btn_Confirm->setBrightModeEnterLeaveColor(QColor(50,200,230),Cell_Const::GRAYLEVEL218);
    Btn_Confirm->setDarkModeEnterLeaveColor(QColor(50,200,230),Cell_Const::GRAYLEVEL70);
    Btn_Confirm->setAnimationDuration(300);
    Btn_Confirm->Init();
    Btn_Confirm->setGeometry(12, 410, 80, 25);
    Btn_Confirm->setCursor(Qt::PointingHandCursor);

    Btn_Confirm_label->setObjectName(QStringLiteral("Btn_Confirm_label"));
    Btn_Confirm_label->setGeometry(25, 2, 50, 20);
    Btn_Confirm_label->setText(tr("确认"));
    Btn_Confirm_label->setFont(QFont(QStringLiteral("微软雅黑 Light")));
    Btn_Confirm_label->setColor(Cell_Const::GRAYLEVEL70);

    Btn_Cancel->setObjectName(QStringLiteral("Btn_Cancel"));
    Btn_Cancel->setBrightModeEnterLeaveColor(QColor(50,200,230),Cell_Const::GRAYLEVEL218);
    Btn_Cancel->setDarkModeEnterLeaveColor(QColor(50,200,230),Cell_Const::GRAYLEVEL70);
    Btn_Cancel->setAnimationDuration(300);
    Btn_Cancel->Init();
    Btn_Cancel->setGeometry(104, 410, 80, 25);
    Btn_Cancel->setCursor(Qt::PointingHandCursor);

    Btn_Cancel_label->setObjectName(QStringLiteral("Btn_Cancel_label"));
    Btn_Cancel_label->setGeometry(25, 2, 50, 20);
    Btn_Cancel_label->setText(tr("取消"));
    Btn_Cancel_label->setFont(QFont(QStringLiteral("微软雅黑 Light")));
    Btn_Cancel_label->setColor(Cell_Const::GRAYLEVEL70);
...
void LauncherNewPJDialog::setColorScheme(CellGlobal::COLOR_SCHEME mode){
    ...
    qDebug() << "--------------------------";
#endif
    const QColor thisColor = (mode == CellGlobal::COLOR_SCHEME::_BRIGHT ? Cell_Const::GRAYLEVEL255 : Cell_Const::GRAYLEVEL30);
    const QColor labelColor = (mode == CellGlobal::COLOR_SCHEME::_BRIGHT ? Cell_Const::GRAYLEVEL70 : Cell_Const::GRAYLEVEL255);
    const QColor titleColor = (mode == CellGlobal::COLOR_SCHEME::_BRIGHT ? Cell_Const::GRAYLEVEL218 : Cell_Const::GRAYLEVEL45);
